    ...
    <main>
      ...
      <OneCol>
        ...
        <Section title="Datenschutz">
          <p>Den Umgang mit der Erhebung, Verarbeitung und Löschung von Daten, sowie Ihrer Rechte betreffend dem Datenschutz können Sie aus der <a href={`${process.env.NEXT_PUBLIC_BASE_PATH}/pdf/Datenschutzerklaerung.pdf`} target="_blank">Datenschutzerklärung</a> entnehmen.</p>
        </Section>
        <Section title="Nutzungsbedingungen">
          <p>Den Nutzungsgegenstand und Umgang mit der Applikation und deren Geodaten können Sie aus den <a href={`${process.env.NEXT_PUBLIC_BASE_PATH}/pdf/Nutzungsbedingungen.pdf`} target="_blank">Nutzungsbedingungen</a> entnehmen.</p>
        </Section>
      </OneCol>
    </main>
  );
