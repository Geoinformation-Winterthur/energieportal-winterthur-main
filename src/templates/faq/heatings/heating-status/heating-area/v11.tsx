...
export const V11 = () => {
  ...
  return (
    <p>
      ...
      {t("my_property.heating_faq.districtheating_V11.status_2")}{" "}
      <a
        href={t(
      ...
      <a
        href={t(
          "my_property.heating_faq.districtheating_V11.status_link_target_3"
        )}
        target="_blank"
      >
        {t("my_property.heating_faq.districtheating_V11.status_link_3")}
      </a>
