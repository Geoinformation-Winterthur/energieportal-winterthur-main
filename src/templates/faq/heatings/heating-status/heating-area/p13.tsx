...
export const P13 = () => {
  ...
  return (
    <p>
      ...
      <a
        href={t(
          "my_property.heating_faq.districtheating_P13.status_link_target_3"
        )}
      >
        {t("my_property.heating_faq.districtheating_P13.status_link_3")}
      </a>
      {t("my_property.heating_faq.districtheating_P13.status_4")}
    </p>
  );
};
